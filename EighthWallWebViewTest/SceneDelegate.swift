...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func sceneDidBecomeActive(_ scene: UIScene) {
        NotificationCenter.default.addObserver(forName: NSNotification.Name("ShowWebView"), object: nil, queue: .main) { [weak self] notification in
        ...
        NotificationCenter.default.addObserver(forName: NSNotification.Name("ShowMenu"), object: nil, queue: .main) { [weak self] notification in
            let rootViewController = MenuViewController()
